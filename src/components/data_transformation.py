...
class DataTransformationConfig:
    ...
    transformed_train_file_path = os.path.join(artifact_dir, 'preprocessor.pkl')
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            imputer_step = ('imputer', SimpleImputer(strategy = 'constant', file_value = 0))
...
=======
            train_arr = np.c_[X_train_scaled, np.array(y_train)]  #np.c is concat
>>>>>>> 251c89a (commited)
